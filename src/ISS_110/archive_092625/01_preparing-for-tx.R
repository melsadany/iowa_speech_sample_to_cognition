...
if (nrow(all.files)>0) {
  for(i in 1:nrow(all.files)) {
    cmd <- paste("python", "/Dedicated/jmichaelson-wdata/msmuhammad/pipelines/audio-tx/src/00_transcribe-whisperx-timestamped.py",
  ...
  "bash /Dedicated/jmichaelson-wdata/msmuhammad/projects/RPOE/language/src/ISS/02_transcribe.sh"
}
################################################################################
################################################################################
################################################################################
